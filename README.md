...
You may read **`test/WorldCupBetting.test.ts`** to see what is expected (scenarios A through I).
...
- [ ] `npx hardhat test test/WorldCupBetting.test.ts` passes with your `WorldCupBetting.sol`.
